...
import GoPlus from "~icons/ic/round-plus";
import RoundHomeWork from "~icons/ic/round-home-work";
    ...
    <div className="relative w-fit h-fit backdrop-blur-[2px] px-4 py-2 flex justify-center items-center gap-5 border border-primary max-sm:gap-3">
      {isHomePage ? (
        <div className="flex gap-1.5 items-center min-w-fit">
          <RoundHomeWork className="text-text text-xl max-md:text-sm" />
          <p className="text-text font-medium text-lg max-md:text-sm">MSCSC</p>
        </div>
      ) : (
        <div className="flex gap-1.5 items-center min-w-fit">
      ...
      <div className="flex gap-1 items-center min-w-fit">
        <GoLocation className="text-text max-md:text-sm" />
        <p className="text-text font-medium text-lg max-md:text-sm">
          {isHomePage ? "Mirpur, Dhaka" : eventLocation}
        </p>
      </div>
