...
export default function Footer(): ReactNode {
  ...
  return (
    <footer className="relative bg-primary-bg z-9 border-t-2 border-primary w-full h-fit flex gap-32 pl-[calc((100%-var(--max-width))/2)] max-[1500px]:justify-between max-[1500px]:gap-12 max-[950px]:flex-col max-max-[950px]:self-center max-[950px]:pl-0 before:absolute before:w-full before:h-full before:bg-primary-bg before:left-0 before:top-0 before:-z-9999">
      <FooterInfo
        footerData={{
