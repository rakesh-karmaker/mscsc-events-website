...
export default function NavLinks({
  ...
  return (
    ...
    >
      <ul className="list-none flex gap-3 max-lg:gap-4  max-md:w-full max-md:bg-white/97 max-md:backdrop-blur-[10px] max-md:flex-col max-md:gap-0 max-md:overflow-hidden max-md-ease-in-out">
            ...
            return (
              <>
                {index > 0 ? (
                  <li
                    key={`break-${index}`}
                    className="text-primary/60 pointer-events-none select-none"
                  >
                    /
                  </li>
                ) : null}
