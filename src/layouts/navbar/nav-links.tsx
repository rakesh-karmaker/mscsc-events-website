...
export default function NavLinks({
  ...
  return (
    <div
      className="grid max-md:absolute max-md:top-full max-md:left-0 max-md:w-full transition-all duration-300 max-md:shadow-[0px_0px_0px_1px_rgba(0,0,0,0.04)]"
      style={{
              ...
              >
                ...
                >
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `${isActive ? "text-primary font-medium" : "text-primary/70"} text-[1em] max-lg:text-[0.96em] max-md:text-[1em] hover:text-primary focus:text-primary focus-within:text-primary transition-colors duration-200 max-md:shadow-[0px_0px_0px_1px_rgba(0,0,0,0.04)] max-md:w-full max-md:block max-md:px-[5vw] max-md:py-4 max-md:hover:bg-secondary-bg/40 max-md:focus:bg-secondary-bg/40 max-md:focus-within:bg-secondary-bg/40 rounded-md`
                    }
                  >
